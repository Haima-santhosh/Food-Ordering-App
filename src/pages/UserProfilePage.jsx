 ...
 const [userProfile, setUserProfile] = useState(null);
  ...
  return (
    <div className="min-h-screen bg-white">
      <h1 className="max-w-5xl text-center p-8 text-4xl font-extrabold mb-8 mt-8 border mx-auto rounded-lg shadow-lg">
        My Profile
      </h1>

      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 bg-slate-100 border rounded-xl shadow-xl mb-10 p-8">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-md border p-6 text-center">
            ...
            <p className="text-gray-700 text-sm mt-2">{userProfile.address}</p>
          </div>
   <div className="bg-white rounded-lg shadow-md border p-6">
    ...
    {userProfile.latestOrders?.map((order, index) => (
      <div key={index} className="mb-4 p-3 border rounded-md bg-gray-50">
        <p className="font-semibold text-gray-800">Restaurant: {order.restaurant}</p>
