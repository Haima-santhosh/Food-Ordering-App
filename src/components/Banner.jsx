...
<>
        <div className="min-h-screen grid sm:grid-cols-1 md:grid-cols-2 bg-white shadow-md">
      
      <div className="min-h-screen flex justify-center items-center bg-white">
  <div className="flex flex-col justify-center items-center p-10 gap-8 text-center">

    <h1 className="text-4xl md:text-6xl font-extrabold text-blue-800 leading-snug tracking-tight drop-shadow-md hidden sm:block">
    ...
    <div className="mt-4 mb-4">
      ...
      <div className="flex justify-center items-center gap-6 pt-10">
        {socialMedia.map((item) => (
          <a key={item.image} className="w-10 h-10 rounded-full overflow-hidden border hover:border-blue-800" href={item.link}>
