...
const Filters = ({ onApplyFilters, onClearFilters }) => {
  ...
  return (
    <div className="basis-1/4 bg-slate-100 dark:bg-slate-800 p-6 border border-gray-300 dark:border-slate-700 rounded-md shadow-md h-screen overflow-y-auto">
      ...
      <div className="mb-4">
        <h3 className="font-semibold mb-2 text-gray-800 dark:text-gray-200">Cuisine</h3>
      ...
      <div className="mb-4">
        <h3 className="font-semibold mb-2 text-gray-800 dark:text-gray-200">Dietary</h3>
      ...
      <div className="mb-4">
        <h3 className="font-semibold mb-2 text-gray-800 dark:text-gray-200">Price Range</h3>
      ...
      <div className="mb-4">
        <h3 className="font-semibold mb-2 text-gray-800 dark:text-gray-200">Delivery Time</h3>
